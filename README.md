...
Threat Detection • Incident Response Support • Threat Intelligence • Log Analysis • Risk Assessment • Vulnerability Awareness • Security Monitoring • OPSEC • SIEM Concepts • IDS/IPS Concepts • Cyber Threat Analysis

Networking & Systems
TCP/IP • DNS • DHCP • Network Troubleshooting • Secure Communications • Windows 10/11 • Basic Linux • System Diagnostics • PC Hardware • System Optimization

Tools & Platforms
Microsoft Office • Adobe Creative Cloud • Troubleshooting Tools • Ticketing Systems • Data Analysis • Technical Reporting

Professional Experience
IT Field Technician — Sedona Technologies (2026–Present)
Executed hardware refresh projects across multiple locations
...
Supported secure communications and OPSEC compliance

Division Assistant Leading Petty Officer — U.S. Navy (2017–2018)
Supervised and mentored 72 personnel

Managed training, readiness, and compliance packages

Supported leadership through documentation and secure information handling

Electronic Warfare Operator — U.S. Navy (2014–2017)
Operated and maintained electronic warfare systems

Conducted diagnostics and preventive maintenance
...
Performed network diagnostics (TCP/IP, DNS, DHCP)

Simulated help desk ticket workflows
